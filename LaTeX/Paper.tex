...
%Add sth about NP-Hardness of 2-side label placement!
...
Boundary Labeling in text documents however, is rarely discussed, and only few papers exist about this topic. The programs that employ this style of annotation often also use rather simple algorithms, to mediocre results. However, the few papers that discuss this topic add interesting information to the discussion. %Rewrite Sentence, I don't like it!

The paper about the Luatodonotes-Package\cite{Kindermann2014} uses several styles of drawing leaders, and came to the conclusion that leaders without bends are easier to follow. %Bsp-Bild einfügen!
