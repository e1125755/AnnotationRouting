...
To enable the inspection of individual texts, each text was generated from a randomized seed that is noted at time of creation.
...
The results are saved to a CSV-style text file, and a R script is generated to visualize the data.

\section{Results}

%TODO:Run several tests with different parameters!
