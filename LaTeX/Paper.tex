...
A \emph{Graph} $G=\langle V, E \rangle$ is a tuple of \emph{Vertices} (V) and \emph{Edges} (E).Vertices are... % Each edge $e_i~\in~E \, (i~\in~\mathbb{N})$ is 
