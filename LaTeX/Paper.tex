...
While this allows for more space in which labels can be placed, it also means that the distance between Label and site often increases, which leads to longer leaders, and often more curves as well.%''Final Priority'' klingt komisch -> Ersatz finden!


\subsection{Implementation}
The program was written in Java, using only JGraphT %Source & How do I link to this?
...
We left some space in between the text area and the label area %Name=?
