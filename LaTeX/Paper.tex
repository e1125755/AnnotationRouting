...
While there haven't been many papers written about this topic, they do offer interesting contributions. For example, the paper\cite{Kindermann2014} about the Luatodonotes-Package illustrates some of the different leader types available, and came to the conclusion that leaders without bends are easier to follow. %Bild einfügen?
